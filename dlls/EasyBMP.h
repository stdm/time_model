...
//ifndef-block by thilo to compensate for warning if already defined
...
void EASYBMP_API SetEasyBMPwarningsOff( void );
void EASYBMP_API SetEasyBMPwarningsOn( void );
bool EASYBMP_API GetEasyBMPwarningState( void );
