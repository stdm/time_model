...
#ifndef __DE_SHORT_H__
#define __DE_SHORT_H__
...
(((getc_exit_val = getc(stream)) == EOF) ? \
  exit_msg("read failed: getc returns EOF\n"), 0: getc_exit_val)
...
extern void	fwrite_type PROTO ((long**, int, int, int, char*));
...
extern void	uvar_put PROTO ((long, int, FILE*));
...
/**********************/
/* defined in array.c */
extern void* 	pmalloc PROTO ((long));
extern long**	long2d PROTO ((long, long));
