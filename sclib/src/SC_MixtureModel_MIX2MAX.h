...
/*				found by Wei Ho 'Wesley' Tsai                                   */
/*																																				*/
/*    Author  : Thilo Stadelmann																					*/
/*    Date    : 22.02.2006																								*/
/**************************************************************************/

#ifndef __SC_MixtureModel_MIX2MAX_H__
#define __SC_MixtureModel_MIX2MAX_H__

#include "SC_MixtureModel.h"
#include "SC_MixtureModel_GMM.h"

class SC_MixtureModel_MIX2MAX : public SC_MixtureModel {
...
public :
	  ...
	  // constructor
	  //====================================================================================================================
		SC_MixtureModel_MIX2MAX(SC_TweakableParameters* pTweak, SC_MixtureModel* pBackground, unsigned short int mixtureCount, unsigned short int dim);
    SC_MixtureModel_MIX2MAX(const SC_MixtureModel_MIX2MAX& pParent);
	  
		//====================================================================================================================
		// destructor
		// attention: doesn't delete the integrated background-gmm!
		//====================================================================================================================
		virtual ~SC_MixtureModel_MIX2MAX();

    //====================================================================================================================
    // overloaded assignment-operator
    //====================================================================================================================
    SC_MixtureModel_MIX2MAX& operator=(const SC_MixtureModel_MIX2MAX& pParent);
    ...
    virtual SC_Model*	  combineModels(SC_Model* pFirst, SC_Model* pSecond, bool keepDummyMixture, bool keepFirstsNext);
		SC_MixtureModel_MIX2MAX* combineModels(SC_MixtureModel* pSecond);
    SC_MixtureModel_MIX2MAX* combineModels(SC_MixtureModel_MIX2MAX* pFirst, SC_MixtureModel* pSecond, bool keepFirstsNext = false);
    SC_MixtureModel_MIX2MAX* combineModels(SC_MixtureModel_MIX2MAX* pFirst, SC_MixtureModel* pSecond, bool keepDummyMixture, bool keepFirstsNext);
		...
		SC_MixtureModel_MIX2MAX* combineModels(SC_MixtureModel* pSecond, SV_Data* pSpeechFrames, unsigned long int segmentsToMerge, SC_MixtureModel* pBackgroundModels);
