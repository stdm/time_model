...
PREFIX=/d/Data/Code/Sprecherklassifikation/dlls
prefix=$(DESTDIR)${PREFIX}
libdir=$(DESTDIR)/d/Data/Code/Sprecherklassifikation/dlls
shlibdir=$(DESTDIR)${PREFIX}/bin
incdir=$(DESTDIR)/d/Data/Code/Sprecherklassifikation/dlls/ffmpeg
...
LDFLAGS=  -Wl,--warn-common -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavutil
LDCONFIG=ldconfig
FFSERVERLDFLAGS=-Wl,-E
SHFLAGS=-shared -Wl,--output-def,$(@:.dll=.def),--out-implib,lib$(SLIBNAME:$(SLIBSUF)=.dll.a) -Wl,--enable-runtime-pseudo-reloc -Wl,--enable-auto-image-base
...
SRC_PATH="/d/Data/Code/ffmpeg-svn"
SRC_PATH_BARE=/d/Data/Code/ffmpeg-svn
BUILD_ROOT="/d/Data/Code/ffmpeg-svn"
